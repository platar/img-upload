...
import info.lavait.imgupload.bucket.BucketName;
import info.lavait.imgupload.filestore.FileStore;
...
public class UserProfileService {
    ...
    private void isImage(MultipartFile file) {
        if (!Arrays.asList(IMAGE_JPEG.getMimeType(), IMAGE_PNG.getMimeType(), IMAGE_SVG.getMimeType()).contains(file.getContentType())) {
